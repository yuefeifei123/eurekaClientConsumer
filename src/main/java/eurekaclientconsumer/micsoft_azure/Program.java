package eurekaclientconsumer.micsoft_azure;
...
////    Azure AD 应用程序所在的 Azure AD 租户域
//    private static String tenant = "xiaopengyue.partner.onmschina.cn";
////    Azure AD 应用程序的客户端 ID
//    private static String clientId = "77f2bdcc-e54f-491d-9a35-d49ee6841e2d";
////    Azure AD 应用程序的客户端密钥
//    private static String clientKey = "aaRG3C6w3gxsQtIUk+bqQUSCmQXN+BnlFy0XldFrQ6Y=";
////    Azure 媒体服务帐户的 REST API 终结点
//    private static String restApiEndpoint = "https://xiaopengyue.restv2.chinanorth.media.chinacloudapi.cn/api/";
    private static String tenant = "dreamguy.partner.onmschina.cn";
    private static String clientId = "d869af5f-3a64-4640-aaf3-41744ae372d8";
    private static String clientKey = "jR482hisoZWNsr+CA6lYGPwcj6qDnt909Mx1sliVPcI=";
    private static String restApiEndpoint = "https://tahrdreamguytest.restv2.chinanorth.media.chinacloudapi.cn/api/";
    // Media Services API
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            AssetInfo uploadAsset = uploadFileAndCreateAsset("nec_test", "C:/imgFile/test2.mp4");
